...
public class RhesisPlusModle implements Serializable{
	...
	private String rhesis_translation;
	...
	private String rhesis_creator_ID;
	...
	public String getRhesis_translation() {
		return rhesis_translation;
	}

	public void setRhesis_translation(String rhesis_translation) {
		this.rhesis_translation = rhesis_translation;
	}
	...
	public String getRhesis_creator_ID() {
		return rhesis_creator_ID;
	}

	public void setRhesis_creator_ID(String rhesis_creator_ID) {
		this.rhesis_creator_ID = rhesis_creator_ID;
	}
